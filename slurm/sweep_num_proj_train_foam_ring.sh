...
export SAVE_NAME=(14418069 14418070 14418071 14418073 14418074 14418075 14418077 14418079 14418080)
export EPOCHS=0
export MONITOR_JOBS=False
export TIME=00:05:00
# End of change for final evaluation

export RING_VAL=0.01
export RING=True
...
export MAX_SUBMISSIONS=4 # Max number of submission events
