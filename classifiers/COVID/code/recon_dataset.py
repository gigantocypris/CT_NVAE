...
import cv2
from recon_utils import read_filepaths, read_filepaths2
...
class COVID_CT_Dataset(Dataset):
    ...
    def __init__(self, args, mode, n_classes=2, dataset_path='./datasets', dim=(224, 224)):
        ...
        trainfile = '/pscratch/sd/h/hojunek/2DCOVID/SARS_npy_test_preprocess/train_split.txt'
        testfile = '/pscratch/sd/h/hojunek/2DCOVID/SARS_npy_test_preprocess/test_split.txt'
