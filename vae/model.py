# ---------------------------------------------------------------
# Original code copyright (c) 2020, NVIDIA CORPORATION. All rights reserved.
#
# This work is licensed under the NVIDIA Source Code License
# for NVAE. To view a copy of this license, see the LICENSE_NVIDIA file.
#
# Modifications from the original code at LINK are licensed under the Apache license,
# see the LICENSE file. (git diff commands)
# ---------------------------------------------------------------
